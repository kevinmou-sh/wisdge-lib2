...
import com.wisdge.ezcell.meta.ExcelColumnProperty;
...
public class TypeUtil {
	...
	public static Map<String, Object> getFieldValues(List<String> stringList, ExcelHeadProperty excelHeadProperty, Boolean use1904WindowDate) {
