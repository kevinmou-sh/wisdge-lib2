...
import com.wisdge.ezcell.annotation.ExcelColumnNo;
import com.wisdge.ezcell.annotation.ExcelProperty;
...
public class ExcelHeadProperty {
	...
	private void initOneColumnProperty(Field field) {
		ExcelProperty p = field.getAnnotation(ExcelProperty.class);
		...
		if (p != null) {
			...
			ExcelColumnNo columnNum = field.getAnnotation(ExcelColumnNo.class);
			if (columnNum != null) {
				excelHeadProperty = new ExcelColumnProperty();
				excelHeadProperty.setField(field);
