...
public class ExportExcelUtils {
    ...
    public static <T> void export(String excelName, List<T> list, Class<T> c, HttpServletResponse response) throws Exception{
        ...
        fillSheet(sheet, list, fieldMap, style, columnStyle);
     ...
     * @throws Exception 异常
     */
    public static <T> void fillSheet(HSSFSheet sheet, List<T> list, LinkedHashMap<String, String> fieldMap, HSSFCellStyle style, HSSFCellStyle columnStyle) throws Exception {
