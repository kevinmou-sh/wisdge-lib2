...
public class FileExtProvider {
	...
	private static synchronized void initialize() {
		...
		try {
			...
			InputStream in = FileExtProvider.class.getClassLoader().getResourceAsStream("FileExtType.xml");
	...
	public static byte[] getImgByExt(String ext) throws IOException {
		...
		try (InputStream in = FileExtProvider.class.getClassLoader().getResourceAsStream("file-types-images/" + imgFilename)) {
