...
public class SM2Util extends GMBaseUtil {
     ...
     * @throws InvalidCipherTextException
     */
    public static String encrypt(ECPublicKeyParameters pubKeyParameters, String content) throws InvalidCipherTextException {
        return new String(encrypt(Mode.C1C3C2, pubKeyParameters, content.getBytes(StandardCharsets.UTF_8)));
    }
